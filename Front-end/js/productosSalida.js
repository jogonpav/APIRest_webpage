            ...
            res.forEach((productos) => {
                ...
                resultados += `<tr>
                        ...
                        <td class="text-center" width="15%">
                            ...
                            <a class='btn btnEditar btn-info btn-xs' ><span class="glyphicon glyphicon-floppy-saved"></span> Dar Salida</a>
                        </td>
                    </tr>`
            });
...
formProductos.addEventListener('submit', (e) => {
    if(parseInt(cantidadProducto.value)>parseInt(cantidadActualProducto.value)){
        alert('La cantidad ingresada supera el stock existente')
        location.reload()
    }else{
    e.preventDefault()
    let metodo = ""
